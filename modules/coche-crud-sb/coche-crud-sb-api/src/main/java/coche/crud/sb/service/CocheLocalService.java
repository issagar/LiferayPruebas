...
public interface CocheLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CocheLocalServiceUtil} to access the coche local service. Add custom service methods to {@link coche.crud.sb.service.impl.CocheLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Coche createCoche(long CocheId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Coche deleteCoche(long CocheId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Coche fetchCoche(long CocheId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Coche fetchCocheByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Coche getCoche(long CocheId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Coche getCocheByUuidAndCompanyId(java.lang.String uuid,
