...
package escritorSb.service.persistence.impl;
...
import escritorSb.exception.NoSuchLibroException;

import escritorSb.model.Libro;

import escritorSb.model.impl.LibroImpl;
import escritorSb.model.impl.LibroModelImpl;

import escritorSb.service.persistence.EscritorPersistence;
import escritorSb.service.persistence.LibroPersistence;
 ...
 * @see escritorSb.service.persistence.LibroUtil
 * @generated
 */
@ProviderType
public class LibroPersistenceImpl extends BasePersistenceImpl<Libro>
	...
	protected Libro toUnwrappedModel(Libro libro) {
		...
		libroImpl.setEscritores(libro.getEscritores());
	 ...
	 */
	@Override
	public List<escritorSb.model.Escritor> getEscritors(long pk) {
	 ...
	 */
	@Override
	public List<escritorSb.model.Escritor> getEscritors(long pk, int start,
		int end) {
	...
	@Override
	public List<escritorSb.model.Escritor> getEscritors(long pk, int start,
		int end, OrderByComparator<escritorSb.model.Escritor> orderByComparator) {
	 ...
	 */
	@Override
	public void addEscritor(long pk, escritorSb.model.Escritor escritor) {
		Libro libro = fetchByPrimaryKey(pk);
	 ...
	 */
	@Override
	public void addEscritors(long pk, List<escritorSb.model.Escritor> escritors) {
		addEscritors(pk,
			ListUtil.toLongArray(escritors,
				escritorSb.model.Escritor.ESCRITOR_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void removeEscritor(long pk, escritorSb.model.Escritor escritor) {
	...
	public void removeEscritors(long pk,
		List<escritorSb.model.Escritor> escritors) {
		removeEscritors(pk,
			ListUtil.toLongArray(escritors,
				escritorSb.model.Escritor.ESCRITOR_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void setEscritors(long pk, List<escritorSb.model.Escritor> escritors) {
		try {
			long[] escritorPKs = new long[escritors.size()];

			for (int i = 0; i < escritors.size(); i++) {
				escritorSb.model.Escritor escritor = escritors.get(i);
	...
	protected TableMapper<Libro, escritorSb.model.Escritor> libroToEscritorTableMapper;
