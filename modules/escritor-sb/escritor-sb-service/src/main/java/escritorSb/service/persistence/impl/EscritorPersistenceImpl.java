...
import escritorSb.exception.NoSuchEscritorException;

import escritorSb.model.Escritor;

import escritorSb.model.impl.EscritorImpl;
import escritorSb.model.impl.EscritorModelImpl;
 ...
 * @see escritorSb.service.persistence.EscritorUtil
 * @generated
 */
@ProviderType
public class EscritorPersistenceImpl extends BasePersistenceImpl<Escritor>
	 ...
	 */
	@Override
	public List<escritorSb.model.Libro> getLibros(long pk) {
	 ...
	 */
	@Override
	public List<escritorSb.model.Libro> getLibros(long pk, int start, int end) {
	...
	@Override
	public List<escritorSb.model.Libro> getLibros(long pk, int start, int end,
		OrderByComparator<escritorSb.model.Libro> orderByComparator) {
	 ...
	 */
	@Override
	public void addLibro(long pk, escritorSb.model.Libro libro) {
		Escritor escritor = fetchByPrimaryKey(pk);
	 ...
	 */
	@Override
	public void addLibros(long pk, List<escritorSb.model.Libro> libros) {
		addLibros(pk,
			ListUtil.toLongArray(libros,
				escritorSb.model.Libro.LIBRO_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void removeLibro(long pk, escritorSb.model.Libro libro) {
	 ...
	 */
	@Override
	public void removeLibros(long pk, List<escritorSb.model.Libro> libros) {
		removeLibros(pk,
			ListUtil.toLongArray(libros,
				escritorSb.model.Libro.LIBRO_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void setLibros(long pk, List<escritorSb.model.Libro> libros) {
		try {
			long[] libroPKs = new long[libros.size()];

			for (int i = 0; i < libros.size(); i++) {
				escritorSb.model.Libro libro = libros.get(i);
	...
	protected TableMapper<Escritor, escritorSb.model.Libro> escritorToLibroTableMapper;
