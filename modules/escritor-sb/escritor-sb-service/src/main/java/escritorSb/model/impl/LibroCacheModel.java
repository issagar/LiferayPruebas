...
public class LibroCacheModel implements CacheModel<Libro>, Externalizable {
	...
	public Libro toEntityModel() {
		...
		if (escritores == Long.MIN_VALUE) {
			libroImpl.setEscritores(null);
		}
		else {
			libroImpl.setEscritores(new Date(escritores));
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		escritores = objectInput.readLong();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(escritores);
	}
