...
import escritorSb.model.LibroModel;
import escritorSb.model.LibroSoap;
...
public class LibroModelImpl extends BaseModelImpl<Libro> implements LibroModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(escritorSb.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.escritorSb.model.Libro"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(escritorSb.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.escritorSb.model.Libro"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(escritorSb.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.escritorSb.model.Libro"),
			true);
	...
	public static Libro toModel(LibroSoap soapModel) {
		...
		model.setEscritores(soapModel.getEscritores());
	...
	public static final boolean FINDER_CACHE_ENABLED_LIBRO_LIBROS_ESCRITORES = GetterUtil.getBoolean(escritorSb.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.Libro_Libros_Escritores"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(escritorSb.service.util.ServiceProps.get(
				"lock.expiration.time.escritorSb.model.Libro"));
	...
	public Object clone() {
		...
		libroImpl.setEscritores(getEscritores());
	...
	public CacheModel<Libro> toCacheModel() {
		...
		Date escritores = getEscritores();

		if (escritores != null) {
			libroCacheModel.escritores = escritores.getTime();
		}
		else {
			libroCacheModel.escritores = Long.MIN_VALUE;
		}
	...
	public String toXmlString() {
		...
		sb.append("escritorSb.model.Libro");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>escritores</column-name><column-value><![CDATA[");
		sb.append(getEscritores());
		sb.append("]]></column-value></column>");
