...
/**
 * This class is used by SOAP remote services, specifically {@link escritorSb.service.http.LibroServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see escritorSb.service.http.LibroServiceSoap
 * @generated
 */
@ProviderType
public class LibroSoap implements Serializable {
	public static LibroSoap toSoapModel(Libro model) {
		...
		soapModel.setEscritores(model.getEscritores());
