...
public class EscritorWrapper implements Escritor, ModelWrapper<Escritor> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<escritorSb.model.Escritor> toCacheModel() {
		return _escritor.toCacheModel();
	}

	@Override
	public escritorSb.model.Escritor toEscapedModel() {
		return new EscritorWrapper(_escritor.toEscapedModel());
	}

	@Override
	public escritorSb.model.Escritor toUnescapedModel() {
		return new EscritorWrapper(_escritor.toUnescapedModel());
	}

	@Override
	public int compareTo(escritorSb.model.Escritor escritor) {
