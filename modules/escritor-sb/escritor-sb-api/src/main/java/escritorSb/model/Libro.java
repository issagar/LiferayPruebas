 ...
 * @see LibroModel
 * @see escritorSb.model.impl.LibroImpl
 * @see escritorSb.model.impl.LibroModelImpl
 * @generated
 */
@ImplementationClassName("escritorSb.model.impl.LibroImpl")
@ProviderType
public interface Libro extends LibroModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link escritorSb.model.impl.LibroImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
