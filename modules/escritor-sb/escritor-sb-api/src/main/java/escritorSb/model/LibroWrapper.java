...
public class LibroWrapper implements Libro, ModelWrapper<Libro> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("escritores", getEscritores());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Date escritores = (Date)attributes.get("escritores");
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<escritorSb.model.Libro> toCacheModel() {
		return _libro.toCacheModel();
	}

	@Override
	public escritorSb.model.Libro toEscapedModel() {
		return new LibroWrapper(_libro.toEscapedModel());
	}

	@Override
	public escritorSb.model.Libro toUnescapedModel() {
		return new LibroWrapper(_libro.toUnescapedModel());
	}

	@Override
	public int compareTo(escritorSb.model.Libro libro) {
	...
	*/
	...
	/**
	* Returns the escritores of this libro.
	*
	* @return the escritores of this libro
	*/
	@Override
	public Date getEscritores() {
		return _libro.getEscritores();
	}
	...
	*/
	...
	/**
	* Sets the escritores of this libro.
	*
	* @param escritores the escritores of this libro
	*/
	@Override
	public void setEscritores(Date escritores) {
		_libro.setEscritores(escritores);
	}
