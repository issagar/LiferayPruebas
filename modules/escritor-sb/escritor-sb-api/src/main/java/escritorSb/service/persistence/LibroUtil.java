 ...
 * @see escritorSb.service.persistence.impl.LibroPersistenceImpl
 * @generated
 */
@ProviderType
public class LibroUtil {
	...
	*/
	public static Libro findByUuid_First(java.lang.String uuid,
		...
		throws escritorSb.exception.NoSuchLibroException {
	...
	*/
	public static List<escritorSb.model.Escritor> getEscritors(long pk) {
	...
	*/
	public static List<escritorSb.model.Escritor> getEscritors(long pk,
		int start, int end,
		OrderByComparator<escritorSb.model.Escritor> orderByComparator) {
	...
	*/
	public static void addEscritor(long pk, escritorSb.model.Escritor escritor) {
