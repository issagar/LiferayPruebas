 ...
 * {@link escritorSb.service.impl.EscritorLocalServiceImpl} and is the
 ...
 * @see escritorSb.service.base.EscritorLocalServiceBaseImpl
 * @see escritorSb.service.impl.EscritorLocalServiceImpl
 * @generated
 */
@ProviderType
public class EscritorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link escritorSb.service.impl.EscritorLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static escritorSb.model.Escritor addEscritor(
		escritorSb.model.Escritor escritor) {
	...
	*/
	public static escritorSb.model.Escritor createEscritor(long escritorId) {
	...
	*/
	public static escritorSb.model.Escritor deleteEscritor(
		escritorSb.model.Escritor escritor) {
	...
	*/
	public static escritorSb.model.Escritor deleteEscritor(long escritorId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteEscritor(escritorId);
	}

	public static escritorSb.model.Escritor fetchEscritor(long escritorId) {
	...
	*/
	public static escritorSb.model.Escritor fetchEscritorByUuidAndGroupId(
	...
	* @throws PortalException if a escritor with the primary key could not be found
	*/
	public static escritorSb.model.Escritor getEscritor(long escritorId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static escritorSb.model.Escritor getEscritorByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static escritorSb.model.Escritor updateEscritor(
		escritorSb.model.Escritor escritor) {
	...
	*/
	public static java.util.List<escritorSb.model.Escritor> getEscritors(
		int start, int end) {
	...
	*/
	public static java.util.List<escritorSb.model.Escritor> getEscritorsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<escritorSb.model.Escritor> getEscritorsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<escritorSb.model.Escritor> orderByComparator) {
		return getService()
				   .getEscritorsByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}

	public static java.util.List<escritorSb.model.Escritor> getLibroEscritors(
		long libroId) {
	...
	*/
	...
	public static void addLibroEscritors(long libroId,
		java.util.List<escritorSb.model.Escritor> escritors) {
