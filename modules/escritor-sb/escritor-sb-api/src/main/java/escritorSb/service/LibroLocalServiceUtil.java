 ...
 * {@link escritorSb.service.impl.LibroLocalServiceImpl} and is the
 ...
 * @see escritorSb.service.base.LibroLocalServiceBaseImpl
 * @see escritorSb.service.impl.LibroLocalServiceImpl
 * @generated
 */
@ProviderType
public class LibroLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link escritorSb.service.impl.LibroLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static escritorSb.model.Libro addLibro(escritorSb.model.Libro libro) {
	...
	*/
	public static escritorSb.model.Libro createLibro(long libroId) {
	...
	*/
	public static escritorSb.model.Libro deleteLibro(
		escritorSb.model.Libro libro) {
	...
	*/
	public static escritorSb.model.Libro deleteLibro(long libroId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteLibro(libroId);
	}

	public static escritorSb.model.Libro fetchLibro(long libroId) {
	...
	*/
	public static escritorSb.model.Libro fetchLibroByUuidAndGroupId(
	...
	* @throws PortalException if a libro with the primary key could not be found
	*/
	public static escritorSb.model.Libro getLibro(long libroId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static escritorSb.model.Libro getLibroByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static escritorSb.model.Libro updateLibro(
		escritorSb.model.Libro libro) {
	...
	*/
	...
	public static java.util.List<escritorSb.model.Libro> getEscritorLibros(
		long escritorId) {
	...
	public static java.util.List<escritorSb.model.Libro> getEscritorLibros(
		long escritorId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<escritorSb.model.Libro> orderByComparator) {
		return getService()
	...
	*/
	public static java.util.List<escritorSb.model.Libro> getLibros(int start,
		int end) {
	...
	*/
	public static java.util.List<escritorSb.model.Libro> getLibrosByUuidAndCompanyId(
	...
	*/
	...
	public static void addEscritorLibros(long escritorId,
		java.util.List<escritorSb.model.Libro> libros) {
