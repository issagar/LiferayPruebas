...
public interface EscritorPersistence extends BasePersistence<Escritor> {
	...
	*/
	public java.util.List<escritorSb.model.Libro> getLibros(long pk);
	...
	*/
	public java.util.List<escritorSb.model.Libro> getLibros(long pk, int start,
		int end);
	...
	*/
	public void addLibros(long pk, java.util.List<escritorSb.model.Libro> libros);
	...
	*/
	public void setLibros(long pk, java.util.List<escritorSb.model.Libro> libros);
