<div class="layaout-navarra" id="main-content" role="main">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-8 portlet-column" id="column-6">
			$processor.processColumn("column-6", "portlet-column-content")
		</div>
		<div class="col-md-2 portlet-column portlet-column-last" id="column-7">
